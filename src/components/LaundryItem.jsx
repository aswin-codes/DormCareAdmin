...
const LaundryItem = ({laundry}) => {
    const  deleteLaundry = async () => {
       await fetch(`http://localhost:3000/laundry/${laundry.id}`,
        {
            method : 'DELETE'
        }
       )
    ...
    <li
          ...
          >
            ...
            <select
              ...
              onChange={(event) => handleStatusChange(event, laundry.id)}
            >
